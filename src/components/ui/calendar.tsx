  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        row: "flex w-full my-6 justify-between",
        cell: cn(
        ...
        day_selected:
          "bg-primary text-white hover:bg-primary hover:text-zinc-50 focus:bg-primary focus:text-zinc-50 dark:bg-zinc-50 dark:text-zinc-900 dark:hover:bg-zinc-50 dark:hover:text-zinc-900 dark:focus:bg-zinc-50 dark:focus:text-zinc-900",
        day_today: "bg-primary/20 text-zinc-900 dark:bg-zinc-800 dark:text-zinc-50 aria-selected:bg-primary aria-selected:text-white",
        day_outside:
